...
export default function Page2_Animation() {
  ...
  // Получение баланса TON из summary-файла
  ...
  function updateSummaryData() {
    ...
    fetch(summaryFile)
      ...
      .then(text => {
        ...
        const nftMatch = text.match(/Количество NFT: (\d+)/);
        if (nftMatch) setNftCount(nftMatch[1]);
      })
      .catch(() => { setTonBalance(null); setTokensCount(null); setNftCount(null); });
  }
  ...
  return (
    <>
      ...
      <div className="page2-cyber-bg">
        ...
        {/* Вся анимация вынесена наружу, без формы и заголовка */}
          ...
          <div className="cyber-diagnosis-anim">
            ...
            <div style={{paddingLeft: 14, paddingRight: 14, boxSizing: 'border-box', width: '100%'}}>
              <div className="cyber-diagnosis-bar" style={{position: 'relative'}}>
                ...
                {/* Индикаторная шкала (grid/glow overlay) */}
